"""
parse_tmx.py  –  Extract (sv, en-gb) sentence pairs from Client TMX files.

Usage:
    python scripts/parse_tmx.py

Output:
    data/client_baseline/processed/sentence_pairs.jsonl
"""
...
TMX_FILES = [
    "Client-master-sv-en-gb.tmx",
    "Client-2281 Q1 2026-sv-en-gb-sv-en-gb.tmx",
]
