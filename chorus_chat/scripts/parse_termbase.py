"""
parse_termbase.py – Extract (Swedish → English) term pairs from Client CSV termbases.

Usage:
    python scripts/parse_termbase.py

Output:
    data/client_baseline/processed/termbase.jsonl
    data/client_baseline/processed/termbase_summary.txt
"""
...
RAW_DIR = Path("data/client_baseline/raw/Client_package")
OUT_DIR  = Path("data/client_baseline/processed")
OUT_FILE = OUT_DIR / "termbase.jsonl"

# (filename, en_col_indices, sv_col_indices)  — 0-based
CSV_CONFIGS = [
    ("Client termbase.csv",        "client",        [11,14,17,20], [24,27,30,33]),
