...
violations in Swedish→English financial translations (Client AB, translated
...
> `data/raw/Client_package/` and run the pipeline below.
...
```bash
mkdir -p data/raw/Client_package
...
31 violation rules derived directly from the Client style guide:
