...
- `vector` — agents receive the top-5 relevant IFRS/Catena terminology matches retrieved from a 3,266-term database
...
| `terminology` | Terminology | IFRS/IAS domain terms, Catena-specific glossary consistency |
...
**Coordination-addressable** — errors that require judgment, context, or knowledge of Catena's house style that no terminology database can supply:
...
|---------|-------------|------|
| Master TMX | Human-translated sv→en-GB Catena sentence pairs | 17,103 segments |
| Catena termbase | Client-specific Swedish–English terminology | 1,938 terms |
